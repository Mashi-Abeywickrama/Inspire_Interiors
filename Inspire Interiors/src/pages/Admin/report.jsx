...
export default function report() {
  ...
  return (
    <div className="d-flex container-fluid flex-column">
      <div className="d-flex flex-column fs-2">Report</div>

      
        <div className=" d-flex flex-row gap-4">
          <div className="d-flex flex-column gap-2 p-2 bg-white rounded-4 flex-fill col-lg-4">
            <span className="d-flex fs-4 card-title">Summary</span>
            <div className="card-1 d-flex  flex-row fs-4 gap-4 justify-content-center flex-fill">
              <div className="ammount">223</div>
              <div className="text">Users</div>
            </div>
            <div className="card-2 d-flex  flex-row gap-4 justify-content-center fs-4 flex-fill">
              <div className="ammount">223</div>
              <div className="text">Project</div>
            </div>
            <div className="card-3 d-flex  flex-row gap-4 justify-content-center fs-4 flex-fill">
              <div className="ammount-1">223</div>
              <div className="text-1">Transaction</div>
            </div>
            <div className="card-4 d-flex  flex-row gap-4 justify-content-center fs-4 flex-fill">
              <div className="ammount-1">223</div>
              <div className="text-1">Revenue</div>
            </div>
          </div>

          <div className="d-flex flex-column gap-2 p-2 bg-white rounded-4 ">
            <span className="d-flex fs-4 card-title">Top Performance</span>
            <div className="d-flex flex-row gap-2">
              <div className="d-flex flex-column gap-2">
                <div className="card-project d-flex  flex-row fs-5 flex-fill col">
                  <div className="d-flex flex-column">
                    <div className="d-flex flex-row gap-2 p-2">
                      <p className="topic d-flex fs-5 font-weight-normal">
                        Best Project
                      </p>
                      <p className="d-flex fs-6 p-2">
                        of the year<i class="bi bi-caret-down-fill"></i>
                      </p>
                    </div>
                    <div className="d-flex flex-row p-2 gap-3 justify-content-center">
                      <img className="img1 d-flex" src={Img1} />
                      <div className="d-flex flex-column ">
                        <span className="card-text d-flex fs-6">
                          designer: tata
                        </span>
                        <span className="card-text d-flex fs-6">
                          Earning: tata
                ...
                <div className="card-project d-flex  flex-row fs-5 flex-fill">
                  <div className="d-flex flex-column">
                    <div className="d-flex flex-row gap-2 p-2">
                      <p className="topic d-flex fs-4 font-weight-normal">
                        Best Project
                      </p>
                      <p className="d-flex fs-6 p-2">
                        of the year<i class="bi bi-caret-down-fill"></i>
                    ...
                    <div className="d-flex flex-row p-2 gap-3 justify-content-center">
                      <div className="d-flex flex-column">
                        ...
                        <span className="d-flex fs-6 justify-content-center rank">
                          Rank 2
                        </span>
                        <span className="d-flex fs-6 justify-content-center name">
                          willy Wonka
                        </span>
                      </div>
                      <div className="d-flex flex-column">
        ...
        <div className="d-flex flex-row gap-4 col-lg-12">

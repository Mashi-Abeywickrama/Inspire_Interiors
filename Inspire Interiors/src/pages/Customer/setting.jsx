...
import EditAddressButton from "../../components/customer/popup/editAddressButton";
...
import DeleteAddressButton from '../../components/customer/popup/deleteAddressButton';
...
const CusSetting = () => {
    ...
    useEffect(() => {
        ...
        // Send the updated data to the server using Axios or your preferred HTTP library
        axiosInstance
            .post('/shippingaddresses', requestData)
            .then(response => {
                // Assuming response.data is an array of shipping addresses
                                        ...
                                        <div className='mb-3' key={index}>
                                            ...
                                            <div className='d-flex gap-4 align-items-center justify-content-between'>
                                                <div className='d-flex justify-content-start gap-3 align-items-center'>
                                                    <div className="mb-2 mt-2 address-radio-form">
                                                        <Form.Check
                                                            type="radio"
                                                            id={`option${index}`} // Use a unique ID for each radio button
                                                            checked={selectedOption === `option${index}`}
                                                            onChange={handleRadioChange}
                                                            label={address.address_title}
                                                        />
                                                    </div>
                                                    <p className="address-tag m-0 p-1 Cabin-text">{address.tag.toUpperCase()}</p>
                                                </div>

                                                <div className="d-flex">
                                                <EditAddressButton addressData={address} />
                                                    <DeleteAddressButton addressID={address.addressid}/>
                                                </div>

                                            </div>

                                            <p className='m-0 address-sub-para'>{`${address.lane}, ${address.city}, ${address.district}`}</p>
                                            <p className='m-0 address-sub-para mb-4'>{address.province} Province</p>

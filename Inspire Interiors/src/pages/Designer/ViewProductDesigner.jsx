        ...
        <>
            <div className="product-container view-product p-4 bg-white rounded-3 mb-4 me-3">
                ...
                <div className="d-flex gap-4">
                    ...
                    <Icon.ChevronRight color="#A2A3B1" size={20} className="mt-1" />
                    <Link to="/designer/promotion"><p className="fs-5 fw-bold Cabin-text text-dark">{productData.type}</p></Link>
                    <Icon.ChevronRight color="#A2A3B1" size={20} className="mt-1" />
...
export default ViewProductDesigner;
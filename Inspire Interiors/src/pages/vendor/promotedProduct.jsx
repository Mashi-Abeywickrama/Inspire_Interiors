                                    ...
                                    <div class="card-body m-0 p-0 mt-3">
                                        <div className="d-flex flex-row justify-content-evenly align-items-center gap-3">
                                            <div className="d-flex flex-column">
                                                <p className="card-text m-0 fs-6 fw-semibold Cabin-text" style={{ color: "#969696"}}>WELCOME ROOM</p>
                            ...
                            <div class="col">
                                <div class="card p-2 h-100 mb-2 rounded-3 border-0 shadow">
                                    ...
                                    <div class="card-body m-0 p-0 mt-3">
                                        <div className="d-flex flex-row justify-content-evenly align-items-center gap-3">
                                            <div className="d-flex flex-column">
                                                <p className="card-text m-0 fs-6 fw-semibold Cabin-text" style={{ color: "#969696"}}>LIVING ROOM</p>
                            ...
                            <div class="col">
                                <div class="card p-2 h-100 mb-2 rounded-3 border-0 shadow">
                                    ...
                                    <div class="card-body m-0 p-0 mt-3">
                                        <div className="d-flex flex-row justify-content-evenly align-items-center gap-3">
                                            <div className="d-flex flex-column">
                                                <p className="card-text m-0 fs-6 fw-semibold Cabin-text" style={{ color: "#969696"}}>DINING ROOM</p>
                            ...
                            <div class="col">
                                <div class="card p-2 h-100 mb-2 rounded-3 border-0 shadow">
                                    ...
                                    <div class="card-body m-0 p-0 mt-3">
                                        <div className="d-flex flex-row justify-content-evenly align-items-center gap-3">
                                            <div className="d-flex flex-column">
                                                <p className="card-text m-0 fw-semibold fs-6 Cabin-text" style={{ color: "#969696"}}>DINING ROOM</p>
                                                <p class="card-title fw-bold fs-6 m-0 Cabin-text">Odger</p>
                                                <p className="card-text m-0 fs-6 fw-bolder Cabin-text">$499</p>
                                            </div>
                                            <Icon.EyeFill className="align-items-center" size={35} style={{ color: "white", backgroundColor: "#035C94", padding: '8px', borderRadius: '5px' }} />

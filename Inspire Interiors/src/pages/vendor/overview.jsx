        ...
        <div className='d-flex flex-column gap-2'>
          ...
          <div className="col-lg-12 bg-white rounded-3 my-2 shadow p-4">
            <div className='d-flex flex-row gap-3'>
              <p className='fs-3 fw-bold Cabin-text' style={{ color: "#023047"}}>Stock</p>
              <p className='mt-2 fs-6 fw-semibold Cabin-text' style={{ color: "#035C94"}}>See all<Icon.ArrowRight color="#035C94" /></p>
            </div>

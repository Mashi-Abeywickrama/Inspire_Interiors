      ...
      <div>
          ...
          <div className="container-fluid me-auto banner-height">
            <div className="d-flex inner-height align-items-center justify-content-evenly common-flex ">
              <div className="d-flex flex-column text-width">
                <h1 className="text-white header-title">
                  Let Your Home Be <span className="gold-colour">Unique</span>{" "}
                </h1>
                <p className="text-white header-sub ">
        ...
        <div className="d-flex align-items-center justify-content-center lower-banner gap-5">
          <div className="col-lg-2 d-flex align-items-center flex-column">
            ...
            <p className="lower-banner-sub-title text-center">
              There are many variations of the passages of lorem Ipsum from
              available, majority.
            </p>
            <p className="lower-banner-link">
              Read More
              <Icon.ArrowRight
                color="orange"
                size={15}
        ...
        <div className="about-home container-fluid">
          <div className="d-lg-flex  align-items-center justify-content-center about-home-flex flex-row-reverse gap-5">
            <img
              className=" col-lg-3 img-fluid about-home-img"
              src={Homeimg1}
            ></img>
            <div className="col-lg-3 d-flex flex-column gap-2">
              <p className="about-home-title ">
                We Create The Art Of Stylish Living Stylishly
              </p>
              <p className="about-home-sub-title ">
              ...
              <div className="d-flex gap-4">
                <Icon.Telephone
                  className="telephone-icon align-center"
                  color="black"
                  size={40}
                />
              ...
              <button className="btn secondary-btn rounded-lg">
                Get Started{" "}
                <Icon.ArrowRight
                  color="white"
                  size={15}
        ...
        <div className="testimonial container-fluid">
          <div className="container d-flex align-items-center flex-column">
            <p className=" col-lg-4 col-md-6 testimonial-title">
